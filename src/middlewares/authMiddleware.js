function authMiddleware(req, res, next) {
    ...
    if (req.session.userLogged != undefined) {       //si userlogged(si esta logueado) es falso
        ...
        return res.redirect('login');                 // que redireccione al home o profile o cart
    }
...
/* una vez q tengamos la vista de profile en funcionamiento c sus rutas y controler, conviene requerir este m.w 
